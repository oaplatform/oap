...
public class TemplateGrammarExpression extends TemplateGrammarAdaptor {
	...
	public static final int
		...
		RULE_conditionAtom = 8, RULE_defaultValue = 9, RULE_defaultValueType = 10, 
		RULE_longRule = 11, RULE_function = 12, RULE_functionArgs = 13, RULE_functionArg = 14, 
		RULE_orExprs = 15, RULE_exprs = 16, RULE_expr = 17, RULE_concatenation = 18, 
		RULE_citems = 19, RULE_citem = 20, RULE_math = 21, RULE_number = 22, RULE_mathOperation = 23;
	private static String[] makeRuleNames() {
		return new String[] {
			"expression", "ifCode", "withCode", "exprsCode", "ifCondition", "conditionOr", 
			"conditionAnd", "conditionNot", "conditionAtom", "defaultValue", "defaultValueType", 
	...
	public final DefaultValueTypeContext defaultValueType() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_defaultValueType);
		try {
			setState(156);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final LongRuleContext longRule() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_longRule);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OrExprsContext orExprs() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_orExprs);
		int _la;
		try {
			setState(212);
			_errHandler.sync(this);
	...
	public final ConcatenationContext concatenation() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_concatenation);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(322);
	...
	public final CitemsContext citems() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_citems);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final CitemContext citem() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_citem);
		try {
			setState(348);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final MathContext math() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_math);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(350);
