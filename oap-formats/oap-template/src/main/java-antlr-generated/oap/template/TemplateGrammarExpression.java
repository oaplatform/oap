...
public class TemplateGrammarExpression extends TemplateGrammarAdaptor {
	...
	public static final int
		DEFAULT=1, BLOCK_COMMENT=2, HORZ_WS=3, VERT_WS=4, START_CONCATENATION=5, 
		DOT=6, LPAREN=7, RPAREN=8, LBRACK=9, RBRACK=10, DQUESTION=11, SEMI=12, 
		COMMA=13, PIPE=14, STAR=15, SLASH=16, PERCENT=17, PLUS=18, MINUS=19, DSTRING=20, 
		SSTRING=21, DECDIGITS=22, FLOAT=23, BOOLEAN=24, ID=25, CAST_TYPE=26, ERR_CHAR=27, 
		C_HORZ_WS=28, C_VERT_WS=29, CRBRACE=30, CERR_CHAR=31;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "DEFAULT", "BLOCK_COMMENT", "HORZ_WS", "VERT_WS", "START_CONCATENATION", 
			"DOT", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "DQUESTION", "SEMI", "COMMA", 
			"PIPE", "STAR", "SLASH", "PERCENT", "PLUS", "MINUS", "DSTRING", "SSTRING", 
			"DECDIGITS", "FLOAT", "BOOLEAN", "ID", "CAST_TYPE", "ERR_CHAR", "C_HORZ_WS", 
			"C_VERT_WS", "CRBRACE", "CERR_CHAR"
		};
	}
	...
	public static class ConcatenationContext extends ParserRuleContext {
		...
		public TerminalNode START_CONCATENATION() { return getToken(TemplateGrammarExpression.START_CONCATENATION, 0); }
		public CitemsContext citems() {
			return getRuleContext(CitemsContext.class,0);
		}
		public TerminalNode CRBRACE() { return getToken(TemplateGrammarExpression.CRBRACE, 0); }
	...
	public static class CitemContext extends ParserRuleContext {
		...
		public Token DECDIGITS;
		public Token FLOAT;
		public TerminalNode DOT() { return getToken(TemplateGrammarExpression.DOT, 0); }
		public TerminalNode ID() { return getToken(TemplateGrammarExpression.ID, 0); }
		public TerminalNode DSTRING() { return getToken(TemplateGrammarExpression.DSTRING, 0); }
		public TerminalNode SSTRING() { return getToken(TemplateGrammarExpression.SSTRING, 0); }
		public TerminalNode DECDIGITS() { return getToken(TemplateGrammarExpression.DECDIGITS, 0); }
