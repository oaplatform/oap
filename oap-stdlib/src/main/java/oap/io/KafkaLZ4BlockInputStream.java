...
import oap.io.KafkaLZ4BlockOutputStream.BD;
import oap.io.KafkaLZ4BlockOutputStream.FLG;

import java.io.FilterInputStream;
import java.io.IOException;
import java.io.InputStream;

import static oap.io.KafkaLZ4BlockOutputStream.LZ4_FRAME_INCOMPRESSIBLE_MASK;
import static oap.io.KafkaLZ4BlockOutputStream.LZ4_MAX_HEADER_LENGTH;
import static oap.io.KafkaLZ4BlockOutputStream.MAGIC;
...
public final class KafkaLZ4BlockInputStream extends FilterInputStream {
    ...
    public long skip( long n ) throws IOException {
        ...
        if( available() == 0 ) readBlock();
        if( finished ) return 0;
        long count = Math.min( n, available() );
        bufferOffset += count;
        return count;
    }
